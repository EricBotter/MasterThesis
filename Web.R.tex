...
ZeroNet does not really implement an incentive scheme, instead it applies a very simple rule to replicate data: peers that visit a website will also start to serve the downloaded files to other peers. %todo - considerations on this will be on the Analysis?
...
We have described the current state-of-the-art in the decentralized Web scenario. %todo - describe thesis
