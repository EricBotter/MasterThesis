...
%todo(leandro) - "their generalities" sounds a bit weird to me. How about "users provide general personal information"
...
\begin{itemize}
	...
	\item \texttt{ABI}, for storing contract interfaces, which in Ethereum are usually distributed out-of-band but are essential to interact with most contracts; this is in discussion to be approved as EIP 205 at the time of writing.
      %todo(leandro) - missing citation to EIP 205
\end{itemize}
...
% It's a website, and I added cloud-based since it stores songs in the cloud (ex. dropbox and IPFS). I might drop this example if I figure out how to better explain the first sentence in this paragraph.
