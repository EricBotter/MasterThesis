...
\label{ch:background}
%todo - add a definition of the blockchain (at least mention what it provides)
...
\section{Other solutions}
ENS supersedes other previous attempts to implement DNS-like functionality on the Ethereum blockchain: such projects were either simpler in nature or did not include Ethereum specific features, so it would be redundant to include them here.
...
\begin{itemize}
	...
	\item \textbf{Blockstack DNS}: we discuss this in Section~\ref{proj:blockstack}.
\end{itemize}
