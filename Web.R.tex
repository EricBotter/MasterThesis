	...
	\begin{center}
		\begin{tabular}{|l|l|l|} \hline
			...
			Incentive scheme & Based on \textit{tit-for-tat} & 
					\begin{tabular}{@{}l@{}}
						BitSwap strategy\\
						Reference impl. is baed on \textit{debt ratio}
					\end{tabular} \\ \hline
		\end{tabular}
	\end{center}
...
To counter these (and similar, possibly unknown) attacks, DNS Security Extensions (DNSSEC) have been introduced, which allow for resolvers and name servers to sign their messages using public-key cryptography, to ensure that they originate from the actual source. Implementation of DNSSEC has been

\begin{figure}[b]
	\centering
	\includegraphics[width=0.9\linewidth]{img/browser-dns-fail-example}
	\caption{An error message for a failed DNS resolution given by Firefox 61.}
