...
For a more complete and in-depth analysis of Namecoin, including the problem of \textit{squatting} %todo - define if not defined above
and the current state of the network regarding currently valid and active records, we suggest the work of~\cite{kalodner2015empirical}.
