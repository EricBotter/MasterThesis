...
A key feature of the so called Web 2.0 that allowed the rise of social media is the ability to get, store and serve user-generated content. %todo - move this to intro if mentioned in Blockstack
%todo(leandro) - you never define Web 2.0
