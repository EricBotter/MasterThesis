...
% I removed all instances of this on the text.
...
% I changed the sentence below, maybe it clarifies a bit
...
% It's a website, and I added cloud-based since as it stores songs in the cloud (ex. dropbox and IPFS). I might drop this example if I figure out how to better explain the first sentence in this paragraph.
...
% Tor does not implement a distributed web. I will move this in a subsection under Other projects in the next commit to make diffs easier to read.
...
% These types of solutions are not Distributed Web projects (except Freenet, which indeed is in Other solutions).
